...
public class WordCount1 {
    public static Map<String, Integer> count(int threadNum, List<File> files) throws IOException, ExecutionException,
    ...
    private static void mergeSubmitResultIntoFinalResult(Map<String, Integer> resultFromSubmit,
    ...
    static class MySubmit implements Callable<Map<String, Integer>> {
