...
public class CacheClassDecorator {
    ...
    public static <T> Class<T> decorate(Class<T> klass) {
        return (Class<T>) new ByteBuddy().subclass(klass).method(
                ElementMatchers.isAnnotatedWith(Cache.class)).intercept(
                MethodDelegation.to(CacheAdvisor.class)).make().load(klass.getClassLoader()).getLoaded();
    }
    ...
    public static class CacheKey {
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(thisObject, cacheKey.thisObject) && Objects.equals(methodName,
                                                                                     cacheKey.methodName) && Arrays.equals(
                    arguments, cacheKey.arguments);
        }
    ...
    public static class CacheAdvisor {
        ...
        public static Object cache(@SuperCall Callable<Object> superCall, @Origin Method method,
            ...
            final CacheValue resultExistInCache = cacheMap.get(cacheKey);
